...
export function ChartIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M4 19h16" />
      <path d="M6 16l3.5-5 3 3 5-7" />
      <path d="M6 16h.01M9.5 11h.01M12.5 14h.01M17.5 7h.01" />
    </svg>
  );
}
...
export function CollapseIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
