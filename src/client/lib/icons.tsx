/**
 * Inline SVG icon set — only the glyphs the dashboard actually uses.
 *
 * Icons inherit `currentColor` so the surrounding component controls color
 * (theme variables flow through). Sizes via `size` prop.
 */
...
export function StarIcon({ size = 18, filled = false, className, style }: StarProps) {
  return (
    <svg
      width={size}
      height={size}
